 ...
 *
 * Disassembly of DSDT.aml, Wed Apr 15 03:46:51 2020
 *
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xC976E000, 0x0359)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xC8A50F18, 0x10)
    ...
    OperationRegion (ABNV, SystemMemory, 0xC975D000, 0x000D)
